...
<body>
    ...
    <div class="container">
        ...
        <!-- Form Pencarian -->
        <form method="GET" action="{{ route('participants.index') }}" style="margin-bottom: 1.5rem;">
            <input
                type="text"
                name="search"
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td data-label="No.">{{ ($participants->currentPage() - 1) * $participants->perPage() + $loop->iteration }}</td>
